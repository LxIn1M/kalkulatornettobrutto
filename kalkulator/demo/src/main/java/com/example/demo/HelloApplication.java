...
public class HelloApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        primaryStage.setTitle("Kalkulator netto-brutto");
        ToggleGroup methodGroup = new ToggleGroup();
        nettoToBrutto = new RadioButton("netto -> brutto");
        nettoToBrutto.setToggleGroup(methodGroup);
        nettoToBrutto.setSelected(true);

        bruttoToNetto = new RadioButton("brutto -> netto");
        ...
        baseValueField.setPromptText("Wartość bazowa: ");
